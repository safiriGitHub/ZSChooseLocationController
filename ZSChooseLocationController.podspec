#
#  Be sure to run `pod spec lint ZSChooseLocationController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  UIPickerView基本样式的地址选择控件，类似京东中的地址选择控件
                   DESC
  ...
  s.source       = { :git => "https://gitee.com/safiri/ZSChooseLocationController.git", :tag => "#{s.version}" }
  ...
  s.resources = "Sources/Resource/ZSChooseLocation.bundle"
